...
{
    outb(CRT_ADDR_REG, CRT_START_ADDR_H);   // 起始位置高位
    screen = inb(CRT_DATA_REG) << 8;
    outb(CRT_ADDR_REG, CRT_START_ADDR_L);   // 起始位置低位
...
{
    outb(CRT_ADDR_REG, CRT_CURSOR_H);   // 起始位置高位
    pos = inb(CRT_DATA_REG) << 8;
    outb(CRT_ADDR_REG, CRT_CURSOR_L);   // 起始位置低位
